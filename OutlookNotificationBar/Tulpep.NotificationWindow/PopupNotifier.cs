...
namespace Tulpep.NotificationWindow
{
    ...
    public class PopupNotifier : Component
    {
        ...
        [Category("TitleFrom")]
        [Description("Font of the titleFrom")]
        public Font TitleFromFont { get; set; }
        ...
        [Category("Title")]
        [Description("Title text to display.")]
        public string TitleTextFrom { get; set; }
        ...
        [Category("Content")]
        [Description("Show Content Right To Left")]
        ...
        {
            // set default values
            HeaderColor = SystemColors.Desktop;
            BodyColor = SystemColors.Desktop;
            ...
            ContentHoverColor = SystemColors.GrayText;
            GradientPower = 10;
            ContentFont = new Font("Arial", 11,FontStyle.Regular);
            TitleFont = new Font(SystemFonts.CaptionFont, FontStyle.Bold);
            TitleFromFont = new Font(SystemFonts.CaptionFont, FontStyle.Bold);
            ShowGrip = false;
            Scroll = false;
            TitlePadding = new Padding(6);
            ...
            if (!disposed)
            {
                if (!frmPopup.Visible)
                {
                    ...
                    if (Scroll)
                    {
                        ...
                        posStop = Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height-50;
                    }
                    else
                    {
                        posStart = Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height-50;
                        posStop = Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height-50;
                    }
                    opacityStart = 0;
                    opacityStop = 1;
                    ...
                    frmPopup.Location = new Point(Screen.PrimaryScreen.WorkingArea.Right - frmPopup.Size.Width - 50, posStart);
